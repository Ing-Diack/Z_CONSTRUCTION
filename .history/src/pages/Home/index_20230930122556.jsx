            ...
            <div className="col-12">
                <ul className="list-inline">
                  <li className="list-item-inline">  
                    <div className="row align-items-center">
                    <div className="col-2"><i class="fa fa-map-marker" aria-hidden="true"></i></div>
                    <div className="col-3">
                    <i class="fa fa-map-marker" aria-hidden="true"></i>
                    <Title text="Address:" color="#000000" size="25px"><i class="fa fa-map-marker" aria-hidden="true"></i> </Title>
                    </div>
                    </div>
                  </li>
