...
function App() {
  return (
    ...
    <div className='col-md-4 py-5 col-12 service-right'>
      ...
      <li className="list-item-inline mb-3 justify-content-between"> <img src={home} alt="home" width={80} height={80} className="rounded-circle" /> 
         <span className="mx-1 fw-bold fs-4"> <Title text="Home"  color="#ffffff"  size="20px"/> </span>
      </li>
      ...
      <div className="container-fluid"> 
       <div className="row">
        ...
        <div className="col-12 col-md-6">
          <div className="row justify-content-center">
            <div className="col-12">
            <div className="row justify-content-between bg-dark py-4 align-items-center">
            <div className="col-6 text-center" >
            <Title text="Trouvez nous sur nos réseaux sociaux" color="#ffffff" size="20px"/>
            </div>
            <div className="col-6">
              <Describle text="Icons réseaux sociaux" />
            </div>
            ...
            <div className="col-12">
                <ul className="inline">
                  <li className="item-inline">  address</li>
                  <li className="item-inline">  tel</li>
                  <li className="item-inline"> email</li>
                </ul>
            </div>
          </div>
        </div>
