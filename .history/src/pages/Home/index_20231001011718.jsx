...
function App() {
  return (
    ...
    <div className='col-md-4 py-5 col-12 service-right'>
      ...
      <ul className="list-inline">
        <li className="list-item-inline mb-3">
            ...
            <div className="col-6 bg-dark"> <Title text="Home"  color="#ffffff"  size="20px"/>
              </div>
            </div>
        </li>
        <li className="list-item-inline mb-3">
            ...
            <div className="col-6 bg-dark"> <Title text="Bridge"  color="#ffffff"  size="20px"/>
              </div>
            </div>
        </li>
        <li className="list-item-inline mb-3">
            ...
            <div className="col-6 text-start bg-dark"> <Title text="Residentials"  color="#ffffff"  size="20px"/>
              </div>
            </div>
        </li>
        <li className="list-item-inline mb-3">
            ...
            <div className="col-6 bg-dark justify-content-start"> <Title text="Building plans"  color="#ffffff"  size="20px"/>
              </div>
            </div>
        </li>
      </ul>
    ...
    <section>
      ...
      <div className="text-center mb-md-5 mb-3 mt-5"> 
    ...
    <div className="row justify-content-center "> 
      <div className="col-8 mb-5">
          <Title text="Nous avons beaucoup d'expérience, car nous construisons depuis 2010 !" color="white"/>
        </div>
        <div className="col-8 mb-5">
          <Describle text="
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-6">
              <ul className="list-inline">
                      ...
                      <li className="list-inline-item mx-2">
                        <Link to="">  <i class="fa fa-instagram fa-md-2x" aria-hidden="true"></i></Link>
                      </li> 
                      <li className="list-inline-item mx-2">
                        <Link to=""><i class="fa fa-twitter-square fa-md-2x" aria-hidden="true"></i></Link>
                      </li> 
                      <li className="list-inline-item mx-2">
                        <Link to=""> <i class="fa fa-whatsapp fa-md-2x" aria-hidden="true"></i></Link>
                      </li> 
                      <li className="list-inline-item mx-2">
                        <Link to=""> <i class="fa fa-linkedin-square fa-md-2x" aria-hidden="true"></i></Link>
                      </li> 
