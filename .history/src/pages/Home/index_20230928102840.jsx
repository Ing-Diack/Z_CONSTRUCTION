...
function App() {
  return (
    ...
    <div className="col-6">
    <iframe width="100%" height="400" frameborder="0" allow="xr-spatial-tracking; gyroscope; accelerometer" allowfullscreen scrolling="no" src="https://kuula.co/share/collection/7JrKG?logo=1&info=1&fs=1&vr=0&zoom=1&sd=1&autop=8&autopalt=1&thumbs=1"></iframe>
