...
function App() {
  return (
    ...
    <div className="col-12 col-md-4 my-2 my-md-0  bg-dark">
      <Card 
      img={home2}
      title="maison1"
      describle="
    ...
    <div className="col-12 col-md-4 my-2 my-md-0 bg-primary justify-content-center ">
      <Card 
      img={home3}
      title="maison1"
      describle="
    ...
    <div className="col-12 col-md-4 my-2 my-md-0 bg-secondary">
      <Card 
      img={home}
      title="maison1"
      describle="
