...
function App() {
  return (
    ...
    <div className="col-7">
      <Faq question="Votre entreprise est reconnue par l'Etat Malien ?" answer="OUI Z_CONSTRUCTION est certifié par l'Etat Malien" />
      <Faq question="Pouvez-vous me donner un devit complet de tous les coûts ? ?" answer="OUI ....................." />
      <Faq question="Pouvez-vous me donner des références, avec des numéros de contact ?" answer=" Oui  des références peuvent être fournies" />
      <Faq  question="Qu'est-ce qui vous différencie des autres constructeurs ?" answer="
