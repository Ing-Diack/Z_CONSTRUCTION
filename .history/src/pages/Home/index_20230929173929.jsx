      ...
      <div className="container-fluid"> 
       <div className="row">
        ...
        <div className="col-12 col-md-6">
          <div className="row justify-content-center">
            <div className="col-12">
            <div className="row justify-content-between bg-dark py-2 align-items-center">
            <div className="col-6 bg-danger text-center" >
            <Title text="Trouvez nous sur nos réseaux sociaux" color="#ffffff"/>
            </div>
            <div className="col-6">
