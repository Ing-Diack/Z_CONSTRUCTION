...
function App() {
  return (
    ...
    <div className="col-7">
      <Faq headNumber="headingOne" question="Votre entreprise est reconnue par l'Etat Malien ?" answer="OUI Z_CONSTRUCTION est certifié par l'Etat Malien" />
      <Faq headNumber="headingTwo" question="Pouvez-vous me donner un devit complet de tous les coûts ? ?" answer="OUI ....................." />
      <Faq headNumber="headingThree" question="Pouvez-vous me donner des références, avec des numéros de contact ?" answer=" Oui  des références peuvent être fournies" />
      <Faq headNumber="headingFour"  question="Qu'est-ce qui vous différencie des autres constructeurs ?" answer="
      Nous terminons nos projets dans les limites du budget et 
      toujours au-delà de la satisfaction de nos clients.
      Pendant que nous travaillons, nous avons toujours des 
      superviseurs qualifiés sur place tout au long du processus
      de construction afin que la qualité de notre travail soit garantie.
      " />
