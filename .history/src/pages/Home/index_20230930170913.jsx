...
function App() {
  return (
    ...
    <section className="py-2 bg-dark">
      <div className="container">
      <div className="row align-items-center">
        <div className="text-center text-light fs-6 fst-italic">
        Z_CONSTRUCTION 2023 <i class="fa fa-copyright" aria-hidden="true"></i> Developped By:
              <a className="nav-link" to="https://ing-diack.github.io/webSite/" target="_blank"> 
              ABKF_Tech</a>
        </div>
      </div>
      </div>
