            ...
            <div className="col-6">
              <ul className="list-group list-group-horizontal">
                      <li className="list-group-item">
                        <Link to="">  <i className="fa fa-facebook-official fa-1x"  aria-hidden="true"></i></Link>
                      </li> 
                      <li className="list-group-item">
                        <Link to="">  <i class="fa fa-instagram fa-1x" aria-hidden="true"></i></Link>
                      </li> 
                      <li className="list-group-item">
                        <Link to=""><i class="fa fa-twitter-square fa-1x" aria-hidden="true"></i></Link>
                      </li> 
              </ul>        
            </div>
