...
function App() {
  return (
    ...
    <div className="col-12 col-md-3 my-2 my-md-0  bg-dark">
      <Card 
      img={home2}
      title="maison1"
      describle="
    ...
    <div className="col-12 col-md-3 my-2 my-md-0 bg-primary ">
      <Card 
      img={home3}
      title="maison2"
      describle="
    ...
    <div className="col-12 col-md-3 my-2 my-md-0 bg-secondary">
      <Card 
      img={home}
      title="maison3"
      describle="
