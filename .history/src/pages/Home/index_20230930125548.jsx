      ...
      <div className="container-fluid"> 
       <div className="row">
        ...
        <div className="col-12 col-md-6">
          <div className="row justify-content-center">
            <div className="col-12">
            <div className="row justify-content-between   py-4 align-items-center">
            <div className="col-6 text-center" >
            <Title text="Trouvez nous sur nos réseaux sociaux" color="#ffffff" size="20px"/>
            </div>
            <div className="col-6">
              <ul className="list-inline">
                <li className="list-itel-inline"> facebook <i class="fa fa-facebook-official" aria-hidden="true" color="#ffffff"></i></li>
              </ul>
            </div>
