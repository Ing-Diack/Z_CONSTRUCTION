...
function App() {
  return (
    ...
    <div className='row d-block  col-12 col-md-8 service-left align-items-center'>
    ...
    <div className='col-md-4 col-12 service-right align-items-center'>
      ...
      <ul className="list-inline">
        <li className="list-item-inline mb-3">
            ...
            <div className="col-6 mx-3"> <Title text="Home"  color="#ffffff"  size="15px"/>
              </div>
            </div>
        </li>
        <li className="list-item-inline mb-3">
            ...
            <div className="col-6 mx-3"> <Title text="Bridge"  color="#ffffff"  size="15px"/>
              </div>
            </div>
        </li>
        <li className="list-item-inline mb-3">
            ...
            <div className="col-6 mx-3"> <Title text="Residentials"  color="#ffffff"  size="15px"/>
              </div>
            </div>
        </li>
        <li className="list-item-inline mb-3">
            ...
            <div className="col-6 mx-3 "> <Title text="Building plans"  color="#ffffff"  size="15px"/>
              </div>
            </div>
        </li>
      </ul>
