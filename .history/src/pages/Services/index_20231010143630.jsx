        ...
        <div className='col-12 col-md-10'>
         <Title text="Construction,Conception,calcul Structure, Devis"/>
          ...
          <ul className='list-inline'>
            <ListService ><i className="fa fa-check mx-3" aria-hidden="true" style={{color:"#dc3545"}}></i>  Préparation du chantier</ListService>
            <ListService ><i className="fa fa-check mx-3" aria-hidden="true" style={{color:"#dc3545"}}></i>  Excavation et compactage </ListService>
            <ListService><i className="fa fa-check mx-3" aria-hidden="true" style={{color:"#dc3545"}}></i>   Fondations et semelles </ListService>
          </ul>
        </div>
        <div className="col-3">
         <ul className='list-inline'>
            <ListService> <i className="fa fa-check mx-3" aria-hidden="true" style={{color:"#dc3545"}}></i>   Maçonnerie</ListService>
            <ListService> <i className="fa fa-check mx-3" aria-hidden="true" style={{color:"#dc3545"}}></i>  Coffrage</ListService>
            <ListService> <i className="fa fa-check mx-3" aria-hidden="true" style={{color:"#dc3545"}}></i> Imperméabilisation</ListService>
          </ul>
        </div>
        <div className="col-3">
        <ul className='list-inline'>
            <ListService> <i className="fa fa-check mx-3" aria-hidden="true" style={{color:"#dc3545"}}></i> Tous travaux de béton</ListService>
            <ListService> <i className="fa fa-check mx-3" aria-hidden="true" style={{color:"#dc3545"}}></i> Travaux civils</ListService>
            <ListService> <i className="fa fa-check mx-3" aria-hidden="true" style={{color:"#dc3545"}}></i> Des structures en acier </ListService>
