    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-12 col-md-6 bg-dark p-4 text-center align-items-center">
            <Button text="About us" color="#dc3545" size="15px" className="m-auto" />
        </div>
        </div>
      ...
      <div className="row d-flex offset-md-1"> 
        ...
        <div className="row d-flex offest-md-2 mt-3">
        <div className="col-12 col-md-6 bg-secondary">
        <Button text="Contactez-nous" color="#dc3545" size="15px" className="m-auto" />
        </div>
        <div className="col-12 col-md-6 bg-dark p-4 text-center align-items-center">
            <Button text="Nos projets" color="#dc3545" size="15px" className="m-auto" />
        </div>
        </div>
