...
`
  return (
    ...
    <div className='row '>
      <CardAccueilLeft
        ...
        <CardOfServicesList className='col-12 col-md-4'>
            ...
            <Title text="Ce que nous pouvons faire " color="#fa0c24" size="25px"/>
    ...
    <section>
    <Banierre text="Prenez contact avec Z_CONSTRUCTION" btnText="contactez-nous" btnLink="#contacts" />
    </section>
    <section>
    <div className="container-fluid">
      <div className="row">
        <div className="col-12 pt-4  col-md-10 offset-md-2" style={backgrondColor}>
        ...
        <Link to="/about">
          <Button text="About us" color="#dc3545" size="0.8em"  />
        </Link>
      ...
      <div className="col-12 pt-4 col-md-10" style={backgrondColor}>
      <div className="row d-flex offset-md-1"> 
        ...
        <div className='col-12 col-md-10 mb-3 mt-2'>
          ...
          <ul className='list-inline'>
            ...
            <ListService ><i className="fa fa-check mx-2" aria-hidden="true" style={{color:"#dc3545"}}></i>  Robot Structural Analysis  </ListService>
            <ListService> <i className="fa fa-check mx-2" aria-hidden="true" style={{color:"#dc3545"}}></i>   Revit </ListService>
          </ul>
        </div>
        <div className="col-12 col-sm-6 col-md-3">
         <ul className='list-inline'>
            <ListService> <i className="fa fa-check mx-2" aria-hidden="true" style={{color:"#dc3545"}}></i>   SAP2000</ListService>
            <ListService> <i className="fa fa-check mx-2" aria-hidden="true" style={{color:"#dc3545"}}></i>  ETABS</ListService>
            <ListService> <i className="fa fa-check mx-2" aria-hidden="true" style={{color:"#dc3545"}}></i> Sketchup</ListService>
          </ul>
        </div>
        <div className="col-12 col-sm-6 col-md-3">
        <ul className='list-inline'>
        ...
        <div className="row d-flex offest-md-2 mt-3">
        <div className="col-6 bg-secondary p-4 text-center align-items-center">
        <HashLink to="#contacts">
         <Button text="contactez-nous" color="#dc3545" size="0.8em"/>
        </HashLink>
           
        </div>
        <div className="col-6 bg-dark p-4 text-center align-items-center">
        <Link to="/projets">
            <Button text="Nos projets" color="#dc3545" size="0.8em"/>
        </Link>
