        ...
        <div className='col-12 col-md-10'>
         <Title text="Construction,Conception,calcul Structure, Devis"/>
          ...
          <ul className='list-inline'>
            <ListService className='list-item-inline'>Préparation du chantier</ListService>
            <ListService className='list-item-inline'>Excavation et compactage </ListService>
            <ListService className='list-item-inline'> Fondations et semelles </ListService>
          </ul>
        </div>
        <div className="col-3">
         <ul className='list-inline'>
