        ...
        <div className='col-12 col-md-10'>
         <Title text="Construction,Conception,calcul Structure, Devis"/>
          ...
          <ul className='list-inline'>
            <li className='list-item-inline'>Préparation du chantier</li>
            <li className='list-item-inline'>Excavation et compactage </li>
            <li className='list-item-inline'> Fondations et semelles </li>
          </ul>
        </div>
        <div className="col-3">
         <ul>
